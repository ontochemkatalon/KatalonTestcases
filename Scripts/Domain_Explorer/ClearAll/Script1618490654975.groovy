...
CustomKeywords.'javascriptClick.ClickWEBObject.clickUsingJS'(findTestObject('clear all/Page_SciWalker Test/a_Clear all'), 
    0)

CustomKeywords.'javascriptClick.ClickWEBObject.clickUsingJS'(findTestObject('clear all/Page_SciWalker Test/button_Clear'), 
    0)

WebUI.verifyElementNotPresent(findTestObject('clear all/Page_SciWalker Test/a_1 concept selected'), 3)

WebUI.verifyElementText(findTestObject('Object Repository/Domain_Explorer/Page_SciWalker Test/Page_SciWalker Test/input_Domains All (32)_p-inputtext p-compon_5bf855'), 
    '')
